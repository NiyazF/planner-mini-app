            ...
            FilledButton(
              onPressed: () {
                ...
                if (name.isNotEmpty) {
                  Navigator.pop(
                    context,
                    TaskCategory(name: name, colorValue: color.toARGB32()),
                  );
                }
              },
          ...
          child: Column(
            ...
            children: [
              ...
              SettingsTile(
                ...
                title: 'Время',
                value: _time == null ? 'Не задано' : _time!.format(context),
              ...
              SettingsTile(
                ...
                title: 'Приоритет',
                value: ['Низкий', 'Средний', 'Высокий'][_priority - 1],
                onTap: () async {
                    ...
                    builder: (context) => SafeArea(
                      child: Column(
                        ...
                        children: List.generate(
                          3,
                          (i) => ListTile(
                            title: Text(['Низкий', 'Средний', 'Высокий'][i]),
              ...
              SwitchListTile.adaptive(
                ...
                value: _reminder,
                onChanged: !widget.notificationsEnabled || _time == null
                    ? null
